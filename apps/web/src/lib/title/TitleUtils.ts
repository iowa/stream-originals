...
export class TitleUtils {
  ...
  static getYearRange(premiere: string | null, finale?: string | null): string {
    ...
    if (isNaN(startYear)) return AppCons.NOT_AVAILABLE;
